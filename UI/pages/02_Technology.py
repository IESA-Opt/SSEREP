...
# Use the original Paper Plots Technology Analysis sub-tab as a standalone page
...
__import__('streamlit').header("Technology Analysis")
__import__('streamlit').caption("Paper Plots: Technology Analysis")

tab_paper_plots.render_technology_analysis_tab(use_1031_ssp=use_1031_ssp)
