...
def _init_defaults() -> None:
    ...
    # Ensure we use the correct project: prefer session_state['project'], fallback to 1015 SSP if available
    session_project = st.session_state.get('project', None)
    if session_project:
        Hardcoded_values.project = session_project
    else:
        # Default to 1015 SSP if available, otherwise keep current Hardcoded_values.project
        ...
        if '1015 SSP' in available_projects:
            Hardcoded_values.project = '1015 SSP'
            st.session_state['project'] = '1015 SSP'
